...
router.route("/search").get(isAuthenticated_1.isAuthenticated, courseController_1.searchCourse);
...
router.route("/lectures/:courseId/:lectureId").put(isAuthenticated_1.isAuthenticated, isAuthenticated_1.isAdmin, multer_1.default.single("videoFile"), courseController_1.editLecture);
...
router.route("/getPublishedCourse").get(isAuthenticated_1.isAuthenticated, courseController_1.getPublishedCourse);
